      ...
      <div className="signup-box">
        ...
        <form className="signup-form" onSubmit={handleSubmit}>
          ...
          <div className="gender-options">
            <label>
              <input type="radio" name="gender" value="Female" onChange={handleChange} defaultChecked /> Female
            </label>
            <label>
          ...
          <input type="email" name="email" placeholder="Mobile number or email" onChange={handleChange} required />
